...
(function () {
    angular.module('index', ['smart-table', 'ui.bootstrap'])
        .controller('indexCtrl', function ($rootScope, $scope, $http, $modal) {
            $scope.rowCollection = [];
            ...
            $scope.deleteProject = function (providerOrderId) {
                bootbox.confirm("Are you sure to delete this provider order?", function (result) {
                    if (result) {
                        url = _basePath + "/api/providerOrder/" + providerOrderId;
                        $http.delete(url).then(function (response) {
                            if (response.data.successMsg) {
                                ...
                                var index = _.findIndex($scope.rowCollection, { "Id": providerOrderId });
